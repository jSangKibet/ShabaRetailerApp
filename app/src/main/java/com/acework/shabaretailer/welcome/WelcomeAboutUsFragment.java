...
public class WelcomeAboutUsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_welcome_about_us_pre, container, false);
    }
    ...
    private void animate() {
        root.postDelayed(() -> {
            Scene next = Scene.getSceneForLayout(root, R.layout.fragment_welcome_about_us, requireContext());
            Transition set = TransitionInflater.from(requireContext()).inflateTransition(R.transition.welcome_about_us);
